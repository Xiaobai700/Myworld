<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column align="center" prop="roleName" label="角色" width="320"></el-table-column>
      ...
      <el-table-column align="center" label="菜单&权限">
        <template slot-scope="scope">
          ...
          <div v-else>
            <div v-for="menu in scope.row.menus">
      ...
      <el-table-column align="center" label="管理" v-if="hasPerm('role:update') ||hasPerm('role:delete') ">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="dialogStatus=='create'" @click="createRole" type="success">创建</el-button>
        <el-button type="primary" v-else @click="updateRole">修改</el-button>
      </div>
    </el-dialog>
  </div>
</template>
